...
if len(sys.argv) < 2:
    print("Usage: python eval_adapter_checkpoint_param.py <checkpoint_path>")
    sys.exit(1)
...
print(f"Loading benchmark for {ckpt_name}...")
...
for split in bench:
    ...
    for sample in tqdm(bench[split], desc=f"{ckpt_name}/{split}"):
